...
export default {
  ...
  "en": {
    ...
    "pen.stamp": "stamp",
    "pigpio.set_gpio": "set gpio [GPIO] to [OUTPUT]",
    "pigpio.get_gpio": "gpio [GPIO] is high?",
    "pisensehat.set_pixel": "set pixel [X],[Y] to R [R] G [G] B [B]",
    "pisensehat.set_pixel_col": "set pixel [X],[Y] to [COLOUR]",
    "pisensehat.set_all_pixels": "set all pixels to R [R] G [G] B [B]",
    "pisensehat.set_all_pixels_col": "set all pixels to [COLOUR]",
    "pisensehat.show_letter": "show letter [LETTER] at rotation [ROT] in [COLOUR] background [BCOLOUR]",
    "pisensehat.scroll_message": "scroll message [MESSAGE] at rotation [ROT] in [COLOUR] background [BCOLOUR]",
    "pisensehat.get_temp": "temperature",
    "pisensehat.get_press": "pressure",
    "pisensehat.get_humid": "humidity",
    "pisensehat.get_ox": "roll",
    "pisensehat.get_oy": "pitch",
    "pisensehat.get_oz": "yaw",
    "speech.defaultWhenIHearValue": "let''s go",
    "speech.extensionName": "Speech to Text",
